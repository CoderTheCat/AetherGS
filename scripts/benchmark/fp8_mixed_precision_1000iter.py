...
def run_test(scene_name="garden", iterations=1000, output_path=None, use_fp8=True):
    """运行 FP8 混合精度训练测试"""
    ...
    model_name = f"fp8_{scene_name}_{iterations}iter" if use_fp8 else f"baseline_{scene_name}_{iterations}iter"
