...
def run_test(scene_name="garden", iterations=1000, output_path=None, use_enhanced=True):
    """运行视锥剔除增强测试"""
    ...
    model_name = f"enhanced_culling_{scene_name}_{iterations}iter" if use_enhanced else f"baseline_{scene_name}_{iterations}iter"
